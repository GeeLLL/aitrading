"""Runner for pilot-20260721-0823 (PILOT_SAMPLE, NVDA slot).
...
(verified unchanged at 2026-07-21T15:24Z before this run.)
...
PAYLOAD = sys.argv[1]
OUT = "logs/launchd_worker/2026-07-21/_indicators_0823.json"
...
# --- payload integrity, computed from the raw payload itself ---
